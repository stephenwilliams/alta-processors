...
import com.alta189.annotations.RequiresParametersAnnotation;
...
public class RequiresParameterAnnotationProcessor extends AbstractProcessor {
	...
	public boolean process(Set<? extends TypeElement> annotations, RoundEnvironment roundEnv) {
		for (TypeElement e : annotations) {
			RequiresParametersAnnotation requiresParameters = e.getAnnotation(RequiresParametersAnnotation.class);
			for (ExecutableElement method : ElementFilter.methodsIn(roundEnv.getElementsAnnotatedWith(e))) {
